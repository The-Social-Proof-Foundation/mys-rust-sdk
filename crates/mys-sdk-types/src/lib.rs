//! Core type definitions for the [Mys] blockchain.
//!
//! [Mys] is a next-generation smart contract platform with high throughput, low latency, and an
//! asset-oriented programming model powered by the Move programming language. This crate provides
//! type definitions for working with the data that makes up the [Mys] blockchain.
//!
//! [Mys]: https://mys.io
//!
//! # Feature flags
...
//! extensively throughout the MySo ecosystem. In particular the BCS format is leveraged because it
...
//! that the network produces. The one caveat to this would be that as the MySo protocol evolves,
...
//! new variants and types as they are released to Mys's `testnet` network.
//!
...
pub use transaction::CanceledTransactionV2;
...
pub use transaction::ExecutionTimeObservations;
pub use transaction::FundsWithdrawal;
...
pub use transaction::ValidatorExecutionTimeObservation;
pub use transaction::VersionAssignment;
pub use transaction::VersionAssignmentV2;
pub use transaction::WithdrawFrom;
