...
use crate::proto::mys::rpc::v2::ledger_service_client::LedgerServiceClient;
use crate::proto::mys::rpc::v2::move_package_service_client::MovePackageServiceClient;
use crate::proto::mys::rpc::v2::signature_verification_service_client::SignatureVerificationServiceClient;
use crate::proto::mys::rpc::v2::state_service_client::StateServiceClient;
use crate::proto::mys::rpc::v2::subscription_service_client::SubscriptionServiceClient;
use crate::proto::mys::rpc::v2::transaction_execution_service_client::TransactionExecutionServiceClient;
...
impl Client {
    /// URL for the public-good, MySo Foundation provided fullnodes for mainnet.
    pub const MAINNET_FULLNODE: &str = "https://fullnode.mainnet.mys.io";

    /// URL for the public-good, MySo Foundation provided fullnodes for testnet.
    pub const TESTNET_FULLNODE: &str = "https://fullnode.testnet.mys.io";

    /// URL for the public-good, MySo Foundation provided fullnodes for devnet.
    pub const DEVNET_FULLNODE: &str = "https://fullnode.devnet.mys.io";

    /// URL for the public-good, MySo Foundation provided archive for mainnet.
    pub const MAINNET_ARCHIVE: &str = "https://archive.mainnet.mys.io";

    /// URL for the public-good, MySo Foundation provided archive for testnet.
    pub const TESTNET_ARCHIVE: &str = "https://archive.testnet.mys.io";
