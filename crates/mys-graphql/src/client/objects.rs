...
impl Client {
    ...
    /// use mys_sdk_types::Address;
    ///
    /// let client = Client::new("https://testnet.mysocial.network/graphql")?;
...
mod tests {
    ...
    /// BCS-encoded MYS coin from mys-sdk-types test fixtures, encoded as base64.
    fn test_object_bcs() -> String {
        use base64ct::Base64;
        use base64ct::Encoding;

        // From mys-sdk-types/src/object.rs test fixtures (SUI_COIN)
