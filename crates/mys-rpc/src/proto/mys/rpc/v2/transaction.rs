...
impl From<mys_sdk_types::Transaction> for Transaction {
    fn from(value: mys_sdk_types::Transaction) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<mys_sdk_types::Transaction> for Transaction {
    fn merge(&mut self, source: mys_sdk_types::Transaction, mask: &FieldMaskTree) {
...
impl TryFrom<&Transaction> for mys_sdk_types::Transaction {
...
impl From<mys_sdk_types::GasPayment> for GasPayment {
    fn from(value: mys_sdk_types::GasPayment) -> Self {
        Self {
...
impl TryFrom<&GasPayment> for mys_sdk_types::GasPayment {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TransactionExpiration> for TransactionExpiration {
    fn from(value: mys_sdk_types::TransactionExpiration) -> Self {
...
impl TryFrom<&TransactionExpiration> for mys_sdk_types::TransactionExpiration {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TransactionKind> for TransactionKind {
    fn from(value: mys_sdk_types::TransactionKind) -> Self {
        use mys_sdk_types::TransactionKind as K;
...
impl TryFrom<&TransactionKind> for mys_sdk_types::TransactionKind {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ConsensusCommitPrologue> for ConsensusCommitPrologue {
    fn from(value: mys_sdk_types::ConsensusCommitPrologue) -> Self {
        Self {
...
impl TryFrom<&ConsensusCommitPrologue> for mys_sdk_types::ConsensusCommitPrologue {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ConsensusCommitPrologueV2> for ConsensusCommitPrologue {
    fn from(value: mys_sdk_types::ConsensusCommitPrologueV2) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
            commit_timestamp: Some(crate::proto::timestamp_ms_to_proto(
...
impl TryFrom<&ConsensusCommitPrologue> for mys_sdk_types::ConsensusCommitPrologueV2 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ConsensusCommitPrologueV3> for ConsensusCommitPrologue {
    fn from(value: mys_sdk_types::ConsensusCommitPrologueV3) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
            commit_timestamp: Some(crate::proto::timestamp_ms_to_proto(
...
impl TryFrom<&ConsensusCommitPrologue> for mys_sdk_types::ConsensusCommitPrologueV3 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ConsensusCommitPrologueV4> for ConsensusCommitPrologue {
    fn from(
        mys_sdk_types::ConsensusCommitPrologueV4 {
            epoch,
            round,
            sub_dag_index,
            commit_timestamp_ms,
...
impl TryFrom<&ConsensusCommitPrologue> for mys_sdk_types::ConsensusCommitPrologueV4 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ConsensusDeterminedVersionAssignments>
    for ConsensusDeterminedVersionAssignments
{
    fn from(value: mys_sdk_types::ConsensusDeterminedVersionAssignments) -> Self {
        use mys_sdk_types::ConsensusDeterminedVersionAssignments::*;
...
impl TryFrom<&ConsensusDeterminedVersionAssignments>
    for mys_sdk_types::ConsensusDeterminedVersionAssignments
{
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::CanceledTransaction> for CanceledTransaction {
    fn from(value: mys_sdk_types::CanceledTransaction) -> Self {
        Self {
...
impl TryFrom<&CanceledTransaction> for mys_sdk_types::CanceledTransaction {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::CanceledTransactionV2> for CanceledTransaction {
    fn from(value: mys_sdk_types::CanceledTransactionV2) -> Self {
        Self {
            digest: Some(value.digest.to_string()),
            version_assignments: value
                .version_assignments
...
impl TryFrom<&CanceledTransaction> for mys_sdk_types::CanceledTransactionV2 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::VersionAssignment> for VersionAssignment {
    fn from(value: mys_sdk_types::VersionAssignment) -> Self {
        Self {
...
impl TryFrom<&VersionAssignment> for mys_sdk_types::VersionAssignment {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::VersionAssignmentV2> for VersionAssignment {
    fn from(value: mys_sdk_types::VersionAssignmentV2) -> Self {
        Self {
            object_id: Some(value.object_id.to_string()),
...
impl TryFrom<&VersionAssignment> for mys_sdk_types::VersionAssignmentV2 {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::GenesisTransaction> for GenesisTransaction {
    fn from(value: mys_sdk_types::GenesisTransaction) -> Self {
        Self {
            objects: value.objects.into_iter().map(Into::into).collect(),
        }
    }
...
impl TryFrom<&GenesisTransaction> for mys_sdk_types::GenesisTransaction {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::RandomnessStateUpdate> for RandomnessStateUpdate {
    fn from(value: mys_sdk_types::RandomnessStateUpdate) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&RandomnessStateUpdate> for mys_sdk_types::RandomnessStateUpdate {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::AuthenticatorStateUpdate> for AuthenticatorStateUpdate {
    fn from(value: mys_sdk_types::AuthenticatorStateUpdate) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
...
impl TryFrom<&AuthenticatorStateUpdate> for mys_sdk_types::AuthenticatorStateUpdate {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Jwk> for Jwk {
    fn from(mys_sdk_types::Jwk { kty, e, n, alg }: mys_sdk_types::Jwk) -> Self {
        Self {
            kty: Some(kty),
            e: Some(e),
            n: Some(n),
...
impl TryFrom<&Jwk> for mys_sdk_types::Jwk {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::JwkId> for JwkId {
    fn from(mys_sdk_types::JwkId { iss, kid }: mys_sdk_types::JwkId) -> Self {
        Self {
            iss: Some(iss),
            kid: Some(kid),
        }
...
impl From<&mys_sdk_types::JwkId> for JwkId {
    fn from(value: &mys_sdk_types::JwkId) -> Self {
        Self {
...
impl TryFrom<&JwkId> for mys_sdk_types::JwkId {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ActiveJwk> for ActiveJwk {
    fn from(value: mys_sdk_types::ActiveJwk) -> Self {
        Self {
...
impl TryFrom<&ActiveJwk> for mys_sdk_types::ActiveJwk {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ChangeEpoch> for ChangeEpoch {
    fn from(value: mys_sdk_types::ChangeEpoch) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&ChangeEpoch> for mys_sdk_types::ChangeEpoch {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::SystemPackage> for SystemPackage {
    fn from(value: mys_sdk_types::SystemPackage) -> Self {
        Self {
            version: Some(value.version),
...
impl TryFrom<&SystemPackage> for mys_sdk_types::SystemPackage {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::EndOfEpochTransactionKind> for EndOfEpochTransactionKind {
    fn from(value: mys_sdk_types::EndOfEpochTransactionKind) -> Self {
        use end_of_epoch_transaction_kind::Kind;
        use mys_sdk_types::EndOfEpochTransactionKind as K;
...
impl TryFrom<&EndOfEpochTransactionKind> for mys_sdk_types::EndOfEpochTransactionKind {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::AuthenticatorStateExpire> for AuthenticatorStateExpire {
    fn from(value: mys_sdk_types::AuthenticatorStateExpire) -> Self {
        Self {
...
impl TryFrom<&AuthenticatorStateExpire> for mys_sdk_types::AuthenticatorStateExpire {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::ExecutionTimeObservations> for ExecutionTimeObservations {
    fn from(value: mys_sdk_types::ExecutionTimeObservations) -> Self {
        match value {
            mys_sdk_types::ExecutionTimeObservations::V1(vec) => Self {
                version: Some(1),
...
impl TryFrom<&ExecutionTimeObservations> for mys_sdk_types::ExecutionTimeObservations {
    type Error = TryFromProtoError;
...
impl
    From<(
        mys_sdk_types::ExecutionTimeObservationKey,
        Vec<mys_sdk_types::ValidatorExecutionTimeObservation>,
    )> for ExecutionTimeObservation
{
    fn from(
        ...
        use mys_sdk_types::ExecutionTimeObservationKey;
    ...
    )
{
    ...
    fn try_from(value: &ExecutionTimeObservation) -> Result<Self, Self::Error> {
        ...
        let observations = value
            ...
            .iter()
            .map(mys_sdk_types::ValidatorExecutionTimeObservation::try_from)
            .collect::<Result<_, _>>()?;
...
impl From<mys_sdk_types::ValidatorExecutionTimeObservation> for ValidatorExecutionTimeObservation {
    fn from(value: mys_sdk_types::ValidatorExecutionTimeObservation) -> Self {
        Self {
...
impl TryFrom<&ValidatorExecutionTimeObservation>
    for mys_sdk_types::ValidatorExecutionTimeObservation
{
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &ValidatorExecutionTimeObservation) -> Result<Self, Self::Error> {
        Ok(Self {
            validator: value
                ...
                .as_ref()
                .pipe(mys_sdk_types::Bls12381PublicKey::from_bytes)
                .map_err(|e| {
                    TryFromProtoError::invalid(
...
impl From<mys_sdk_types::ProgrammableTransaction> for ProgrammableTransaction {
    fn from(value: mys_sdk_types::ProgrammableTransaction) -> Self {
        Self {
...
impl TryFrom<&ProgrammableTransaction> for mys_sdk_types::ProgrammableTransaction {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Input> for Input {
    fn from(value: mys_sdk_types::Input) -> Self {
        use input::InputKind;
        use mys_sdk_types::Input::*;
...
impl TryFrom<&Input> for mys_sdk_types::Input {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &Input) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            InputKind::ImmutableOrOwned => {
                ...
                let reference = mys_sdk_types::ObjectReference::new(object_id, version, digest);
            ...
            InputKind::Shared => {
                ...
                let shared_input = match value.mutability() {
                    input::Mutability::Unknown => {
                        ...
                        mys_sdk_types::SharedInput::new(object_id, initial_shared_version, mutable)
                    }
                    input::Mutability::Immutable => mys_sdk_types::SharedInput::new(
                        object_id,
                        initial_shared_version,
                        mys_sdk_types::Mutability::Immutable,
                    ),
                    input::Mutability::Mutable => mys_sdk_types::SharedInput::new(
                        object_id,
                        initial_shared_version,
                        mys_sdk_types::Mutability::Mutable,
                    ),
                    input::Mutability::NonExclusiveWrite => mys_sdk_types::SharedInput::new(
                        object_id,
                        initial_shared_version,
                        mys_sdk_types::Mutability::NonExclusiveWrite,
                    ),
                };
...
impl From<mys_sdk_types::Mutability> for input::Mutability {
    fn from(value: mys_sdk_types::Mutability) -> Self {
        match value {
            mys_sdk_types::Mutability::Immutable => Self::Immutable,
            mys_sdk_types::Mutability::Mutable => Self::Mutable,
            mys_sdk_types::Mutability::NonExclusiveWrite => Self::NonExclusiveWrite,
        }
    }
}
...
impl From<mys_sdk_types::FundsWithdrawal> for FundsWithdrawal {
    fn from(value: mys_sdk_types::FundsWithdrawal) -> Self {
        let mut message = Self::default();
...
impl TryFrom<&FundsWithdrawal> for mys_sdk_types::FundsWithdrawal {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &FundsWithdrawal) -> Result<Self, Self::Error> {
        ...
        let source = match value.source() {
            ...
            Source::Sender => mys_sdk_types::WithdrawFrom::Sender,
            Source::Sponsor => mys_sdk_types::WithdrawFrom::Sponsor,
        };
...
impl From<mys_sdk_types::WithdrawFrom> for funds_withdrawal::Source {
    fn from(value: mys_sdk_types::WithdrawFrom) -> Self {
        match value {
            mys_sdk_types::WithdrawFrom::Sender => Self::Sender,
            mys_sdk_types::WithdrawFrom::Sponsor => Self::Sponsor,
            _ => Self::Unknown,
        }
    }
}
...
impl From<mys_sdk_types::Argument> for Argument {
    fn from(value: mys_sdk_types::Argument) -> Self {
        use argument::ArgumentKind;
        use mys_sdk_types::Argument::*;
...
impl TryFrom<&Argument> for mys_sdk_types::Argument {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Command> for Command {
    fn from(value: mys_sdk_types::Command) -> Self {
        use command::Command;
        use mys_sdk_types::Command::*;
...
impl TryFrom<&Command> for mys_sdk_types::Command {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MoveCall> for MoveCall {
...
impl TryFrom<&MoveCall> for mys_sdk_types::MoveCall {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TransferObjects> for TransferObjects {
    fn from(value: mys_sdk_types::TransferObjects) -> Self {
        Self {
            objects: value.objects.into_iter().map(Into::into).collect(),
...
impl TryFrom<&TransferObjects> for mys_sdk_types::TransferObjects {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::SplitCoins> for SplitCoins {
    fn from(value: mys_sdk_types::SplitCoins) -> Self {
        Self {
...
impl TryFrom<&SplitCoins> for mys_sdk_types::SplitCoins {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MergeCoins> for MergeCoins {
    fn from(value: mys_sdk_types::MergeCoins) -> Self {
        Self {
            coin: Some(value.coin.into()),
...
impl TryFrom<&MergeCoins> for mys_sdk_types::MergeCoins {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Publish> for Publish {
    fn from(value: mys_sdk_types::Publish) -> Self {
        Self {
            modules: value.modules.into_iter().map(Into::into).collect(),
            dependencies: value.dependencies.iter().map(ToString::to_string).collect(),
        }
...
impl TryFrom<&Publish> for mys_sdk_types::Publish {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MakeMoveVector> for MakeMoveVector {
    fn from(value: mys_sdk_types::MakeMoveVector) -> Self {
        Self {
...
impl TryFrom<&MakeMoveVector> for mys_sdk_types::MakeMoveVector {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::Upgrade> for Upgrade {
    fn from(value: mys_sdk_types::Upgrade) -> Self {
        Self {
            modules: value.modules.into_iter().map(Into::into).collect(),
            dependencies: value.dependencies.iter().map(ToString::to_string).collect(),
            package: Some(value.package.to_string()),
...
impl TryFrom<&Upgrade> for mys_sdk_types::Upgrade {
    type Error = TryFromProtoError;
