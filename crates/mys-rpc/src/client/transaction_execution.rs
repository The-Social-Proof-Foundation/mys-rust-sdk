...
use crate::proto::mys::rpc::v2::ExecuteTransactionRequest;
use crate::proto::mys::rpc::v2::ExecuteTransactionResponse;
use crate::proto::mys::rpc::v2::ExecutionError;
use crate::proto::mys::rpc::v2::GetEpochRequest;
use crate::proto::mys::rpc::v2::GetTransactionRequest;
use crate::proto::mys::rpc::v2::SubscribeCheckpointsRequest;
...
impl Client {
    ...
    pub async fn execute_transaction_and_wait_for_checkpoint(
        ...
        let transaction_digest = {
            ...
            match mys_sdk_types::Transaction::try_from(transaction) {
