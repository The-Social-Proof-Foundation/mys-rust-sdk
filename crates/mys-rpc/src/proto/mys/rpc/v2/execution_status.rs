...
impl From<mys_sdk_types::ExecutionStatus> for ExecutionStatus {
    fn from(value: mys_sdk_types::ExecutionStatus) -> Self {
        match value {
            mys_sdk_types::ExecutionStatus::Success => Self {
                success: Some(true),
                error: None,
            },
            mys_sdk_types::ExecutionStatus::Failure { error, command } => {
...
impl TryFrom<&ExecutionStatus> for mys_sdk_types::ExecutionStatus {
    ...
    fn try_from(value: &ExecutionStatus) -> Result<Self, Self::Error> {
        ...
        match (success, &value.error) {
            ...
            (false, Some(error)) => Self::Failure {
                error: mys_sdk_types::ExecutionError::try_from(error)
...
impl From<mys_sdk_types::ExecutionError> for ExecutionError {
    fn from(value: mys_sdk_types::ExecutionError) -> Self {
        use execution_error::ErrorDetails;
        use execution_error::ExecutionErrorKind;
        use mys_sdk_types::ExecutionError as E;
...
impl TryFrom<&ExecutionError> for mys_sdk_types::ExecutionError {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &ExecutionError) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            K::InsufficientFundsForWithdraw => Self::InsufficientFundsForWithdraw,
...
impl From<mys_sdk_types::CommandArgumentError> for CommandArgumentError {
    fn from(value: mys_sdk_types::CommandArgumentError) -> Self {
        use command_argument_error::CommandArgumentErrorKind;
        use mys_sdk_types::CommandArgumentError as E;
...
impl TryFrom<&CommandArgumentError> for mys_sdk_types::CommandArgumentError {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::TypeArgumentError> for type_argument_error::TypeArgumentErrorKind {
    fn from(value: mys_sdk_types::TypeArgumentError) -> Self {
        use mys_sdk_types::TypeArgumentError::*;
...
impl TryFrom<type_argument_error::TypeArgumentErrorKind> for mys_sdk_types::TypeArgumentError {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::PackageUpgradeError> for PackageUpgradeError {
    fn from(value: mys_sdk_types::PackageUpgradeError) -> Self {
        use package_upgrade_error::PackageUpgradeErrorKind;
        use mys_sdk_types::PackageUpgradeError as E;
...
impl TryFrom<&PackageUpgradeError> for mys_sdk_types::PackageUpgradeError {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::MoveLocation> for MoveLocation {
    fn from(value: mys_sdk_types::MoveLocation) -> Self {
        Self {
...
impl TryFrom<&MoveLocation> for mys_sdk_types::MoveLocation {
    type Error = TryFromProtoError;
