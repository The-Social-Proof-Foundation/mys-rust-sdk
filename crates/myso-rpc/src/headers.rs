...
pub const X_MYSO_CHAIN_ID: &str = "x-myso-chain-id";

/// Chain name of the current chain
pub const X_MYSO_CHAIN: &str = "x-myso-chain";

/// Current checkpoint height
pub const X_MYSO_CHECKPOINT_HEIGHT: &str = "x-myso-checkpoint-height";
...
///  - effects
///  - events
pub const X_MYSO_LOWEST_AVAILABLE_CHECKPOINT: &str = "x-myso-lowest-available-checkpoint";
