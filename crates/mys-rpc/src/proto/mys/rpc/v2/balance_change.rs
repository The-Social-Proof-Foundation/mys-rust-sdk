...
impl Merge<&mys_sdk_types::BalanceChange> for BalanceChange {
    fn merge(&mut self, source: &mys_sdk_types::BalanceChange, mask: &crate::field::FieldMaskTree) {
...
impl TryFrom<&BalanceChange> for mys_sdk_types::BalanceChange {
