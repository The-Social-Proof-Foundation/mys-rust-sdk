...
pub(crate) enum ResolvedArgument {
    ...
    Resolved(mys_sdk_types::Argument),
}
...
impl TransactionBuilder {
    ...
    pub fn try_build(mut self) -> Result<Transaction, Error> {
        ...
        // Gas payment
        let gas_payment = mys_sdk_types::GasPayment {
            objects: self
                .gas
                .iter()
        ...
        for (id, input) in unresolved_inputs {
            let arg = match input {
                InputArg::Gas => mys_sdk_types::Argument::Gas,
                InputArg::Pure(value) => {
                    resolved_inputs.push(mys_sdk_types::Input::Pure(value));
                    mys_sdk_types::Argument::Input(resolved_inputs.len() as u16 - 1)
                }
        ...
        for (id, command) in self.commands {
            ...
            let arg = mys_sdk_types::Argument::Result(resolved_commands.len() as u16 - 1);

            *self.arguments.get_mut(&id).unwrap() = ResolvedArgument::Resolved(arg);
        }

        Ok(Transaction {
            kind: mys_sdk_types::TransactionKind::ProgrammableTransaction(
                mys_sdk_types::ProgrammableTransaction {
    ...
    #[cfg(feature = "intents")]
    #[cfg_attr(doc_cfg, doc(cfg(feature = "intents")))]
    pub async fn build(mut self, client: &mut mys_rpc::Client) -> Result<Transaction, Error> {
        use mys_rpc::field::FieldMask;
        use mys_rpc::field::FieldMaskUtil;
        use mys_rpc::proto::mys::rpc::v2::Input;
        use mys_rpc::proto::mys::rpc::v2::SimulateTransactionRequest;
        use mys_rpc::proto::mys::rpc::v2::SimulateTransactionResponse;
        use mys_rpc::proto::mys::rpc::v2::input::InputKind;
...
impl Argument {
    ...
    ) -> Result<mys_sdk_types::Argument, Result<usize, Error>> {
    ...
    fn try_resolve_many(
        arguments: &[Self],
        resolved_arguments: &BTreeMap<usize, ResolvedArgument>,
    ) -> Result<Vec<mys_sdk_types::Argument>, Result<usize, Error>> {
        arguments
            .iter()
...
impl Command {
    fn try_resolve(
        &self,
        resolved_arguments: &BTreeMap<usize, ResolvedArgument>,
    ) -> Result<mys_sdk_types::Command, Result<usize, Error>> {
        use mys_sdk_types::Command as C;
        ...
        let cmd = match &self.kind {
            CommandKind::MoveCall(MoveCall {
                ...
                type_arguments,
                arguments,
            }) => C::MoveCall(mys_sdk_types::MoveCall {
                package: *package,
            ...
            CommandKind::TransferObjects(TransferObjects { objects, address }) => {
                C::TransferObjects(mys_sdk_types::TransferObjects {
            ...
            CommandKind::SplitCoins(SplitCoins { coin, amounts }) => {
                C::SplitCoins(mys_sdk_types::SplitCoins {
            ...
            CommandKind::MergeCoins(MergeCoins {
                coin,
                coins_to_merge,
            }) => C::MergeCoins(mys_sdk_types::MergeCoins {
                coin: coin.try_resolve(resolved_arguments)?,
            ...
            CommandKind::Upgrade(Upgrade {
                ...
                package,
                ticket,
            }) => C::Upgrade(mys_sdk_types::Upgrade {
                modules: modules.to_owned(),
                dependencies: dependencies.to_owned(),
                package: *package,
...
impl From<&mys_sdk_types::Object> for ObjectInput {
    fn from(object: &mys_sdk_types::Object) -> Self {
        let input = Self::new(object.object_id())
            .with_version(object.version())
            .with_digest(object.digest());

        match object.owner() {
            mys_sdk_types::Owner::Address(_) => input.as_owned(),
            mys_sdk_types::Owner::Object(_) => input,
            mys_sdk_types::Owner::Shared(version) => input.with_version(*version).as_shared(),
            mys_sdk_types::Owner::Immutable => input.as_immutable(),
            mys_sdk_types::Owner::ConsensusAddress { start_version, .. } => {
...
// impl TryFrom<&mys_rpc::proto::mys::rpc::v2::Object> for ObjectInput {
//     type Error = mys_rpc::proto::TryFromProtoError;

//     fn try_from(object: &mys_rpc::proto::mys::rpc::v2::Object) -> Result<Self, Self::Error> {
//         todo!()
//     }
// }
...
impl ObjectInput {
    ...
    fn try_into_input(&self) -> Result<mys_sdk_types::Input, Error> {
        let input = match self {
            ...
            | Self {
                ...
                digest: Some(digest),
                mutable: None,
            } => mys_sdk_types::Input::ImmutableOrOwned(mys_sdk_types::ObjectReference::new(
            ...
            Self {
                ...
                digest: Some(digest),
                ..
            } => mys_sdk_types::Input::Receiving(mys_sdk_types::ObjectReference::new(
                *object_id, *version, *digest,
            )),
            ...
            | Self {
                ...
                digest: None,
                mutable: Some(mutable),
            } => mys_sdk_types::Input::Shared(mys_sdk_types::SharedInput::new(
    ...
    #[cfg(feature = "intents")]
    fn to_input_proto(&self) -> mys_rpc::proto::mys::rpc::v2::Input {
        use mys_rpc::proto::mys::rpc::v2::input::InputKind;

        let mut input =
            mys_rpc::proto::mys::rpc::v2::Input::default().with_object_id(self.object_id);
        match self.kind {
    ...
    fn try_into_object_reference_proto(
        &self,
    ) -> Result<mys_rpc::proto::mys::rpc::v2::ObjectReference, Error> {
        if !matches!(self.kind, Some(ObjectKind::ImmutableOrOwned) | None) {
            return Err(Error::WrongGasObject);
        }

        let mut input =
            mys_rpc::proto::mys::rpc::v2::ObjectReference::default().with_object_id(self.object_id);
        if let Some(version) = self.version {
            input.set_version(version);
        }
        if let Some(digest) = self.digest {
    ...
    pub(crate) fn try_from_object_proto(
        object: &mys_rpc::proto::mys::rpc::v2::Object,
    ) -> Result<Self, Error> {
