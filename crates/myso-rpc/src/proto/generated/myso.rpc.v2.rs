...
pub struct ExecutedTransaction {
    ...
    /// `myso.types.TransactionEffects.events_digest` is populated if the
    ...
    impl ExecutionErrorKind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::MySoMoveVerificationError => "MY_SO_MOVE_VERIFICATION_ERROR",
                ...
                Self::MySoMoveVerificationTimedout => "MY_SO_MOVE_VERIFICATION_TIMEDOUT",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "MY_SO_MOVE_VERIFICATION_ERROR" => Some(Self::MySoMoveVerificationError),
                ...
                "MY_SO_MOVE_VERIFICATION_TIMEDOUT" => {
...
pub mod ledger_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.LedgerService", "GetServiceInfo"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.LedgerService", "GetObject"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.LedgerService", "BatchGetObjects"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.LedgerService", "GetTransaction"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("myso.rpc.v2.LedgerService", "BatchGetTransactions"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.LedgerService", "GetCheckpoint"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.LedgerService", "GetEpoch"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod ledger_service_server {
    ...
    pub const SERVICE_NAME: &str = "myso.rpc.v2.LedgerService";
...
pub mod move_package_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.MovePackageService", "GetPackage"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "myso.rpc.v2.MovePackageService",
                        "ListPackageVersions",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod move_package_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "myso.rpc.v2.MovePackageService";
...
pub mod name_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/myso.rpc.v2.NameService/LookupName",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.NameService", "LookupName"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/myso.rpc.v2.NameService/ReverseLookupName",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.NameService", "ReverseLookupName"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod name_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "myso.rpc.v2.NameService";
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "myso.rpc.v2.SignatureVerificationService",
                        "VerifySignature",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod signature_verification_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "myso.rpc.v2.SignatureVerificationService";
...
pub struct CoinMetadata {
    ...
    /// 0x2::myso::coin_registry::Currency object (when registered with CoinRegistry).
    #[prost(string, optional, tag = "1")]
    pub id: ::core::option::Option<::prost::alloc::string::String>,
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct Balance {
    /// The type of the coin (e.g., 0x2::myso::MYSO).
    #[prost(string, optional, tag = "1")]
    pub coin_type: ::core::option::Option<::prost::alloc::string::String>,
...
pub struct ListOwnedObjectsRequest {
    ...
    /// `0x2::coin::Coin<0x2::myso::MYSO>` will only return `Coin<MYSO>` objects.
    #[prost(string, optional, tag = "5")]
    pub object_type: ::core::option::Option<::prost::alloc::string::String>,
}
#[non_exhaustive]
...
pub mod state_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.StateService", "ListOwnedObjects"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.StateService", "GetCoinInfo"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.StateService", "GetBalance"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("myso.rpc.v2.StateService", "ListBalances"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod state_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "myso.rpc.v2.StateService";
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "myso.rpc.v2.SubscriptionService",
...
pub mod subscription_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "myso.rpc.v2.SubscriptionService";
...
pub struct ValidatorSet {
    ...
    /// Mappings from staking pool's ID to the myso address of a validator.
    ///
    /// key: address (staking pool Id), value: address (myso address of the validator)
    #[prost(message, optional, tag = "5")]
    ...
    ///
    /// key: address (myso address of the validator), value: 0x3::validator_wrapper::ValidatorWrapper
    #[prost(message, optional, tag = "7")]
...
pub mod transaction_execution_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/myso.rpc.v2.TransactionExecutionService/ExecuteTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "myso.rpc.v2.TransactionExecutionService",
                        "ExecuteTransaction",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/myso.rpc.v2.TransactionExecutionService/SimulateTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod transaction_execution_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "myso.rpc.v2.TransactionExecutionService";
