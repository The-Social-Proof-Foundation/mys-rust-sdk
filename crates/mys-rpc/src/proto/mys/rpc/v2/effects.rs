...
impl From<mys_sdk_types::TransactionEffects> for TransactionEffects {
    fn from(value: mys_sdk_types::TransactionEffects) -> Self {
        Self::merge_from(&value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<&mys_sdk_types::TransactionEffects> for TransactionEffects {
    fn merge(&mut self, source: &mys_sdk_types::TransactionEffects, mask: &FieldMaskTree) {
        ...
        match source {
            mys_sdk_types::TransactionEffects::V1(v1) => self.merge(v1.as_ref(), mask),
            mys_sdk_types::TransactionEffects::V2(v2) => self.merge(v2.as_ref(), mask),
        }
    }
}
...
impl TryFrom<&TransactionEffects> for mys_sdk_types::TransactionEffects {
...
impl Merge<&mys_sdk_types::TransactionEffectsV1> for TransactionEffects {
    fn merge(
        &mut self,
        mys_sdk_types::TransactionEffectsV1 {
            status,
            epoch,
            gas_used,
...
impl Merge<&mys_sdk_types::TransactionEffectsV2> for TransactionEffects {
    fn merge(
        &mut self,
        mys_sdk_types::TransactionEffectsV2 {
            status,
            epoch,
            gas_used,
            transaction_digest,
...
impl From<mys_sdk_types::ChangedObject> for ChangedObject {
    fn from(value: mys_sdk_types::ChangedObject) -> Self {
        ...
        let input_state = match value.input_state {
            mys_sdk_types::ObjectIn::NotExist => InputObjectState::DoesNotExist,
            mys_sdk_types::ObjectIn::Exist {
                version,
                digest,
                owner,
            } => {
        ...
        let output_state = match value.output_state {
            mys_sdk_types::ObjectOut::NotExist => OutputObjectState::DoesNotExist,
            mys_sdk_types::ObjectOut::ObjectWrite { digest, owner } => {
                message.output_digest = Some(digest.to_string());
                message.output_owner = Some(owner.into());
                OutputObjectState::ObjectWrite
            }
            mys_sdk_types::ObjectOut::PackageWrite { version, digest } => {
                message.output_version = Some(version);
                message.output_digest = Some(digest.to_string());
                OutputObjectState::PackageWrite
            }
            mys_sdk_types::ObjectOut::AccumulatorWrite(accumulator_write) => {
...
impl TryFrom<&ChangedObject> for mys_sdk_types::ChangedObject {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &ChangedObject) -> Result<Self, Self::Error> {
        ...
        let input_state = match value.input_state() {
            ...
            InputObjectState::DoesNotExist => mys_sdk_types::ObjectIn::NotExist,
            InputObjectState::Exists => mys_sdk_types::ObjectIn::Exist {
                version: value
                    .input_version
        ...
        let output_state = match value.output_state() {
            ...
            OutputObjectState::DoesNotExist => mys_sdk_types::ObjectOut::NotExist,
            OutputObjectState::ObjectWrite => mys_sdk_types::ObjectOut::ObjectWrite {
                digest: value
                    .output_digest
                    .as_ref()
                    .ok_or_else(|| TryFromProtoError::missing("digest"))?
            ...
            OutputObjectState::PackageWrite => mys_sdk_types::ObjectOut::PackageWrite {
                version: value
                    .output_version
                    .ok_or_else(|| TryFromProtoError::missing("version"))?,
                digest: value
            ...
            OutputObjectState::AccumulatorWrite => mys_sdk_types::ObjectOut::AccumulatorWrite(
                value
...
impl From<mys_sdk_types::IdOperation> for changed_object::IdOperation {
    fn from(value: mys_sdk_types::IdOperation) -> Self {
        use mys_sdk_types::IdOperation::*;
...
impl TryFrom<changed_object::IdOperation> for mys_sdk_types::IdOperation {
    type Error = TryFromProtoError;
...
impl From<mys_sdk_types::AccumulatorWrite> for AccumulatorWrite {
    fn from(value: mys_sdk_types::AccumulatorWrite) -> Self {
        ...
        message.set_operation(match value.operation() {
            mys_sdk_types::AccumulatorOperation::Merge => AccumulatorOperation::Merge,
            mys_sdk_types::AccumulatorOperation::Split => AccumulatorOperation::Split,
...
impl TryFrom<&AccumulatorWrite> for mys_sdk_types::AccumulatorWrite {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &AccumulatorWrite) -> Result<Self, Self::Error> {
        ...
        let operation = match value.operation() {
            ...
            accumulator_write::AccumulatorOperation::Merge => {
                mys_sdk_types::AccumulatorOperation::Merge
            }
            accumulator_write::AccumulatorOperation::Split => {
                mys_sdk_types::AccumulatorOperation::Split
            }
        };
...
impl From<mys_sdk_types::UnchangedConsensusObject> for UnchangedConsensusObject {
    fn from(value: mys_sdk_types::UnchangedConsensusObject) -> Self {
        use mys_sdk_types::UnchangedConsensusKind::*;
...
impl TryFrom<&UnchangedConsensusObject> for mys_sdk_types::UnchangedConsensusObject {
    type Error = TryFromProtoError;
