//! GraphQL client for MySo blockchain.
...
impl Client {
    ...
    ///
    /// let client = Client::new("https://graphql.testnet.mys.io/graphql").unwrap();
    /// ```
    ...
    ///
    /// #[tokio::main]
    /// async fn main() -> Result<(), mys_graphql::Error> {
    ///     let client = Client::new("https://graphql.testnet.mys.io/graphql")?;
    ///     let response = client
